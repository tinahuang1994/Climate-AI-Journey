## 🌍 My Climate AI Engineering Journey
> **How I went from "writing prompts" to building agentic systems for climate data — in public.**
...
## 🚀 The Backstory
In February 2026, I started with a simple goal: figure out how to write better prompts. That curiosity turned into a "rabbit hole" through courses from **Google, Anthropic, Stanford, MIT, Columbia, CalArts, and DeepLearning.AI**.
...
👉 **[View my full portfolio: tinahuang.vercel.app](https://tinahuang.vercel.app/)**

Highlights:
- **Smoke Story** — AI-powered wildfire storytelling tool using geospatial data
- **No Thanks** — Workplace boundary coach using the Eisenhower Matrix
- **Climate Triple Takes** — A digital climate newsletter with 3 distinct framing lenses
...
- **Advanced:** Harness Engineering — building structured, testable AI workflows.
...
Going beyond prompting — learning when to actually change the AI's brain.
...
## 💡 Reflection
This journey taught me that we have finally **scaled our Intellect, not just our Labor.** If you are in the climate space and feel overwhelmed by AI, I hope my notes help you find your own path.
